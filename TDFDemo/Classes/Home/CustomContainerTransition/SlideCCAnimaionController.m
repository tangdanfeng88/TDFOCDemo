...
@interface SlideCCAnimaionController ()<UIViewControllerAnimatedTransitioning>
{
    CCTabOperationDirection _direction;
}
@end
@implementation SlideCCAnimaionController
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    translation = _direction==CC_left ? translation : -translation;

...
#import "ColCircleLayoutVC.h"
#import "CircleLayout.h"
#import "ColImageCell.h"

static NSString * const ID = @"image";

@interface ColCircleLayoutVC ()<UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, strong) NSMutableArray *images;
@property (nonatomic, weak) UICollectionView *collectionView;
@end

@implementation ColCircleLayoutVC
...
- (void)viewDidLoad {
    ...
    CircleLayout *lineLayout = [[CircleLayout alloc] init];
